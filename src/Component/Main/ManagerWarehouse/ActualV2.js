                                        ...
                                        <div class="row right0">
                                            <div className="col-sm-12 col-md-3">
                                                    ...
                                                    <div className="row">
                                                        {/* <div className="col-md-12">
                                                            <div className="form-group">
                                                                ...
                                                                <input type="text" disabled={disable} placeholder="Nhập 1 hoặc nhiều mã,mỗi mã cách nhau bằng khoảng trắng" className="form-control"
                                                                    value={EnterCode}
                                                        ...
                                                        <div className="col-md-12">
                                                            <div className="form-group">
                                                                <label className="form__title" >Putaway staff<span className="form__title__note">(*)</span></label>
                                                                <SelectAccount
                                                        ...
                                                        {/* <div className={IsAcctive2 == true ? "display-none" : ""}>
                                                        </div> */}
                                                        <div className="col-md-12">
                                                            <div className="form-group">
                                                                <label className="form__title" >Customer Recipient </label>
                                                        ...
                                                        <div className="col-md-12">
                                                            <div className="form-group">
                                                                <label className="form__title">
                                                                    Recipient's phone number<span className="form__title__note">(*)</span>
                                                                </label>
                                                                <input
                                                                    type="number"
                                                                    className="form-control"
                                                ...
                                                {/* <div className="card linetop scrollermyscan" style={{ height: '350px' }}>
                                                    <div className="">
                                                        <span className="spaninfored btn-danger"> Sản phẩm lỗi ({DataError.length}) </span>
                                                    </div>
                                                    <div className="col-md-12">
                                                        <div className="row">
                                                            {
                                            ...
                                            <div className="col-sm-12 col-md-9">
                                                <div className="card linetop" style={{ height: '350px' }}>
                                                    <div className="row">
                                                        ...
                                                        <div className="col-md-3">
                                                            <div className="form-group">
                                                                <label className="form__title" >Warehouse<span className="form__title__note">(*)</span></label>
                                                        ...
                                                        <table className="table table-head-fixed text-nowrap table__detail__with___btn table-sticky-thead ">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>Product name</th>
                                                                    <th>Image</th>
                                                                    {Function.Id !== '3' ? <th>Serial/Imei</th> : ""}
                                                                    {/* {Function.Id !== '3' ? <th>Ngày SX</th> : ""}
                                                                    {Function.Id !== '3' ? <th>Hạn SD</th> : ""} */}
                                                                    <th style={{ zIndex: "1" }}>Unit</th>
                                                                    {/* {Function.Id != '4' ? <th>SL dự kiến</th> : ''} */}
                                                                    <th>Quantity</th>
                                                                    {Function.Id !== '1' ? <th>Inventory</th> : ''}
                                                                    {Function.Id !== '4' ? <th>Converted weight (kg)</th> : ''}
                                                                    {/* {Function.Id !== '3' ? <th>Trạng thái lô</th> : ""} */}
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                {
                                                                    DataOK.map((item, k) => {
                                                                        return (
                                                                            <tr key={k + 1} className={item.key = (k + 1)} style={{ color: item.color }}>
                                                                                <td><button type="button" className="btn__detail__table btn__detail__table__delete" onClick={a => Deleterow((k + 1))}>Delete</button></td>
                                                                                <td>{k + 1}</td>
                                                                                ...
                                                                                {Function.Id !== '3' ?
                                                                                    <td className="min-width200">
                                                                                        <div>
                                                                                            <input type="text" key={item.ProductId} min={0} disabled value={item.CodeSeriIme} onChange={e => (item.CodeSeriIme = e.target.value)} className="form-control top-2" />
                                                                                        </div>
                                                                                    </td>
                                                                                    : ""}

                                                                                <td className="min-width200">
                                                                                    <Select className={"SelectMeno min10 margin-5 font12" + (k + 1)}
                                                                                ...
                                                                                <td className="min-width200">
                                                                                    <div className="form-group">
                                                                                        <input type="text" key={(k + 1)} min={0} value={formatNumber(item.PackageNumber)}
                                                                                            ...
                                                                                            disabled={item.Keys === 1 ? true : false}
                                                                                        />
                                                                                    </div>
                                                                                </td>
                                                                                {Function.Id != '1' ?
                                                                                    <td className="min-width200">
                                                                                        <div className="form-group">
                                                                                            <input type="number" key={(k + 1)} min={0} disabled value={item.Inventoryshow} className="form-control top-2 text-center" />
                                                                                        </div>
                                                                                    </td> : ""
                                                                                }
                                                                                {Function.Id != '4' ?
                                                                ...
                                                                return (
                                                                    <>
                                                                        <div class="col-sm-12 col-md-2">
                                                                            <div className={item.Check !== true ? "Layoutmyscan" : "shadowlct"}>
                                                                                <div className="Layoutmyscantt">
                                                                                    {item.LocationName}
                                                                                </div>
                                                                                <div className="Layoutmyscanct">
                                                                                    <span className="borlay"> {item.Number}</span>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </>
