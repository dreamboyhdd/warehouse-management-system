...
export const DasBoardReport = () => {
    ...
    const [DataChartInventoryCustomer, setDataChartInventoryCustomer] = useState([]);
    const [HiddenChart, setHiddenChart] = useState(false);
    const [HiddenChartDate, setHiddenChartDate] = useState(false);
    const [HiddenChartCustomer, setHiddenChartCustomer] = useState(false);
    ...
    //#region chọn khu vực
   /*  const onSelectArea = (-1) => {
        set-1(-1);
        WH_spWareHouse_Statistics(Key-1, -1, parseInt(Month.split('-')[1]), parseInt(Month.split('-')[0]));
        WH_spWareHouse_InventoryRatioByDate_DashBoard(2, -1, (Month.split('-')[1]), parseInt(Month.split('-')[0]));
        WH_spWareHouse_InventoryByCustomer_Report(2, -1, (Month.split('-')[1]), parseInt(Month.split('-')[0]));
    } */
    //#endregion
    ...
    const ChangeKeyTime_Load = (Key, KeyMonths, KeyYears) => {
        ...
        $("#ChartInventoryDate .apexcharts-canvas").remove();
        $("#ChartInventoryCustomer .apexcharts-canvas").remove();
                                                            ...
                                                            <div class="col-sm-12 b-r-default p-b-20 p-t-20 b-r-default">
                                                                <div class="row align-items-center text-center">
                                                                    ...
                                                                    <div class="col-10 p-r-0">
                                                                        ...
                                                                        <p class="text-muted m-b-0">Import </p>
                                                            ...
                                                            <div class="col-sm-12 b-r-default p-b-20 p-t-20 b-r-default">
                                                                <div class="row align-items-center text-center">
                                                                    ...
                                                                    <div class="col-10 p-r-0">
                                                                        ...
                                                                        <p class="text-muted m-b-0">Export</p>
                                                                    </div>
                                                                </div>
                                                            </div>
