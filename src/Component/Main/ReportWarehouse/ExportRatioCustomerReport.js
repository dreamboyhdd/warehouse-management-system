...
export const ExportRatioCustomerReport = () => {
  ...
  //#region list
  const WH_spWareHouse_Export_Report = async () => {
    try {
      ...
      const params = {
        ...
        func: "WH_spWareHouse_Export_Report",
      };
  ...
  //#region list
  const WH_spWareHouse_ExportDetail_Report = async (item) => {
    try {
      const ar = []
      if (item === 1) {
        ar.push({
      ...
      const params = {
        ...
        func: "WH_spWareHouse_ExportDetail_Report",
      };
      const result = await mainAction.API_spCallServer(params, dispatch);
      if (result.length > 0) {
        if (item == 1) {
  ...
  const columnsDetail = [
    {
      Header: (I18n.t("ExportRatioCustomerReport.ProductCode")),
      accessor: "ProductCode",
      sortable: true,
      filterable: true,
    },
    {
      Header: (I18n.t("ExportRatioCustomerReport.ProductName")),
      accessor: "ProductName",
      sortable: true,
      filterable: true,
    },
    {
      Header: (I18n.t("ExportRatioCustomerReport.ProductGroups")),
      accessor: "ProductGroupName",
      sortable: true,
      filterable: true,
    },
    {
      Header: (I18n.t("ExportRatioCustomerReport.Unit")),
      accessor: "ProductPackagingName",
      sortable: true,
      filterable: true,
    },
    {
      Header: (I18n.t("ExportRatioCustomerReport.Exportquantity")),
  ...
  const Exportexcel = (item) => {
    if (DataReportDetail.length === 0) {
      Alertwarning(I18n.t("ExportRatioCustomerReport.Noexceldatayet"));
      return;
    }
    ...
    let _warehouse = DataReport.find(e => e.CustomerId === item.CustomerId)
    let title = "kho :" + _warehouse + "ma khach hang : " + DataReportDetail[0]?.CustomerCode + "Kho: " + WareHouseName + " - Thoi gian : " + FormatDateJson(Fromdate, 5) + " den " + FormatDateJson(Todate, 5)
    ExportExcel(newData, "Bao cao xuat kho - " + title);
  };
            ...
            <div className="report_detail">
              <div className="report_detail_header row">
                <div className="report_detail_header_title col-md-12">
                  {I18n.t("ExportRatioCustomerReport.ReportexportWarehousebycustomer")}
                </div>
                <div className="report_detail_header_content col-md-12">
                  {I18n.t("ExportRatioCustomerReport.CustomerCode")} : {DataReportDetail[0]?.CustomerCode} - {I18n.t("ExportRatioCustomerReport.Warehouse")}: {WareHouseName} - {I18n.t("ExportRatioCustomerReport.Time")}: {FormatDateJson(Fdate, 5)} - {FormatDateJson(Tdate, 5)}
                </div>
              ...
              <div className="row">
                <div className="col-md-6">
                  <h3 className="card-title">
                    ...
                    {I18n.t("ExportRatioCustomerReport.ExportReport")}
                  </h3>
                </div>
                <div className="col-md-6 card-header-btn">
                  <a
                    ...
                    onClick={(e) => {
                      WH_spWareHouse_Export_Report()
                      WH_spWareHouse_ExportDetail_Report(1)
                    }}
                  >
                    ...
                    <div className="rp_card_item active">
                      <div className="rp_card_item_header">
                        <div className="rp_card_item_header_left">
                          ...
                          <div className="rp_content_active">{I18n.t("ExportRatioCustomerReport.Product")}</div>
                        </div>
                        <div className="rp_card_item_header_right">
                          <a
                            ...
                            onClick={e => WH_spWareHouse_ExportDetail_Report(1)}
                          >
                      ...
                      <div className="active rp_card_item_body">
                        <div className="i_body_content">
                          ...
                          <span className="c_text_active">{I18n.t("ExportRatioCustomerReport.Nameofthewarehouse")}:</span>{" "}
                          <span className="c_text_bg_active">{I18n.t("ExportRatioCustomerReport.Allwarehouses")}</span>
                        </div>
                        <div className="i_body_content">
                          <i className="fa-solid fa-circle rp_circle active" />
                          <span className="c_text_active">{I18n.t("ExportRatioCustomerReport.Time")}: {FormatDateJson(Fdate, 5)} - {FormatDateJson(Tdate, 5)}</span>
                        </div>
                        <div className="i_body_content">
                          <i className="fa-solid fa-circle rp_circle active" />
                          <span className="c_text_active">{I18n.t("ExportRatioCustomerReport.Numberofproductcodes")}: {DataReport.reduce((a, v) => a = a + v.TotalProducts, 0)}</span>
                        </div>
                      </div>
                    </div>
                  </div>
                          ...
                          <div className="rp_card_item">
                            <div className="rp_card_item_header">
                              <div className="rp_card_item_header_left">
                                ...
                                <div className="rp_content">{I18n.t("ExportRatioCustomerReport.Product")}</div>
                              </div>
                              <div className="rp_card_item_header_right">
                                <a
                                  data-toggle="modal"
                                  data-target="#myModal2"
                                  className="btn_rp_detail"
                                  onClick={e => WH_spWareHouse_ExportDetail_Report(rp)}
                                >
                            ...
                            <div className="rp_card_item_body">
                              <div className="i_body_content">
                                ...
                                <span className="c_text">{I18n.t("ExportRatioCustomerReport.Nameofthewarehouse")}:</span>{" "}
                              ...
                              <div className="i_body_content">
                                <i className="fa-solid fa-circle rp_circle" />
                                <span className="c_text">{I18n.t("ExportRatioCustomerReport.Numberofproductcodes")}: {rp.TotalProducts} </span>
                              </div>
                            </div>
                          </div>
                        </div>
