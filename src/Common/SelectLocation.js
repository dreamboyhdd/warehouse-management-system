...
const SelectLocationComp = React.forwardRef(({
    ...
    const WH_spWareHouse_Location_Select = async () => {
        ...
        try {
            const params = {
                ...
                func: "WH_spWareHouse_Location_Select",
                API_key: APIKey
            }
            ...
            if (list.length > 0) {
                ...
                list.forEach((element, index) => {
                    dataSelect.push({ value: element.LocationId, label: element.LocationCode + '-' + element.LocationName });
            ...
            console.log(error, "WH_spWareHouse_Location_Select")
        }

    }

    useEffect(() => {
        WH_spWareHouse_Location_Select()
    }, [WareHouseAreaId, WareHouseId, AreaId, ShelvesId, FloorId]);
