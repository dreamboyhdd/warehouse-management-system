...
const SelectProductColorComp = React.forwardRef(({
    onSelected = () => { },
    isDisabled = false,
    isMulti = false,
    activer = [],
        ...
        try {
            ...
            if (list.length > 0) {
                ...
                list.forEach((element, index) => {
                    dataSelect.push({ value: element.ColorId, label: element.ColorName, ColorCode: element.ColorCode });
            ...
            console.log(error, "WH_spProduct_Attribute_Color_List")
        }
...
export const SelectProductColor = React.memo(SelectProductColorComp)