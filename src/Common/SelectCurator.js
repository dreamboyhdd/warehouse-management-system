...
const SelectCuratorComp = React.forwardRef(({
    onSelected = () => { },
    items = 0,
    Id = 0,
    isDisabled = false,
    ...
    const WH_spCurator_Select = async () => {
        ...
        try {
            ...
            console.log(error, "WH_spCurator_Select")
        }
...
export const SelectCurator = React.memo(SelectCuratorComp)