        ...
        try {
            ...
            if (list.length > 0) {
                ...
                list.forEach((element, index) => {
                    dataSelect.push({ value: element.MenuId, label: element.MenuName,value: element.ParentId });
            ...
            console.log(error, "WH_spMenuModule_LoadPermission_List")
        }
...
export const SelectSelectMenuModuleLoadPermission = React.memo(SelectMenuModuleLoadPermissionComp)