...
const SelectFloorComp = React.forwardRef(({
    onSelected = () => { },
    WareHouseAreaId = 0,
    WareHouseId = 0,
    AreaId = 0,
    ...
    const WH_spWareHouse_Floor_Select = async () => {
        ...
        try {
            const params = {
                ...
                func: "WH_spWareHouse_Floor_Select",
                API_key: APIKey
            }
            ...
            if (list.length > 0) {
                ...
                list.forEach((element, index) => {
                    dataSelect.push({ value: element.FloorId, name: element.FloorName, label: element.FloorCode + '-' + element.FloorName });
            ...
            console.log(error, "WH_spWareHouse_Floor_Select")
        }

    }

    useEffect(() => {
        WH_spWareHouse_Floor_Select()
    }, [WareHouseAreaId, WareHouseId, AreaId, ShelvesId]);
...
export const SelectFloor = React.memo(SelectFloorComp)